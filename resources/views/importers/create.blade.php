                    ...
                    <div class="sparkline12-list">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-sample" method="post" action="{{ route('importers.store') }}">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 {{ App()->currentLocale() == 'ar' ? 'pull-right' : '' }}">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="name_lt" id="name_lt" class="form-control" required />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 {{ App()->currentLocale() == 'ar' ? 'pull-right' : '' }}">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input name="address_ar" id="address_ar" type="text" class="form-control" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 {{ App()->currentLocale() == 'ar' ? 'pull-right' : '' }}">
                                            <div class="form-group row">
                                                <label
                                                    class="required col-sm-3 col-form-label {{ App()->currentLocale() == 'ar' ? 'pull-right' : '' }}">{{ __('Address In English/French') }}</label>
                                                <div class="col-sm-9">
                                                    <input name="address_lt" id="address_lt" type="text" class="form-control" required />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#country_id').on('change', function() {
                var selectedCountry = $('#country_id').find(":selected").val();
                $.ajax({
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
                    url: "/getstates/" + selectedCountry,
                    type: "GET",
