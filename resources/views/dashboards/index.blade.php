...
@Push('js') 
    ...
    <script src="{{ URL::asset('dist/js/pages/chartist/chartist-plugin-tooltip.min.js') }}"></script>
    ...
    <script src="{{ URL::asset('dist/js/pages/dashboards/dashboard1.min.js') }}"></script>
