                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="form-sample" method="POST" action="{{ route('purchases.update', $purchase->id) }}">
                                @csrf
                                @method('put')
                                <input hidden type="text" class="form-control" value="{{ $purchase->id ?? '' }}"
                                                        ...
                                                        <tr id="R{{ $count }}">
                                                            ...
                                                            <td>
                                                                <div class="input-group mb-3">
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        value="{{ $purchaseItem->product_sku }}">
                                                            ...
                                                            <td>
                                                                <input type="text" class="form-control" id="price"
                                                                    name="price" placeholder="الثمن دج"
                                                                    aria-label="{{ __('Price') }}"
                                                                    aria-describedby="basic-addon2"
                                                                    value="{{ $purchaseItem->price }}" required>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td class="text-success"><span
                                                                    class="product_total">{{ $purchaseItem->total_amount }}</span>{{__('DA')}}
                                                            </td>
                                                            <td class="datatable-ct">
                                                                <a rel="tooltip" class="remove pd-setting-ed"
                                                                    href="#" data-url="" data-purchase_name="    "
...
@Push('js')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            //                 var product_total = (data.product.price - price) * quantity;
            ...
            $('.form-sample').submit(function(e) {
                ...
                $.ajax({
                    ...
                    data: {"purchase_id":$('#purchase_id').val(), "date": $('#date').val(), "products": JSON.stringify(products)},
                    // cache: false,
                    // processData: false,
                    // contentType: false,
                    success: function(data) {
