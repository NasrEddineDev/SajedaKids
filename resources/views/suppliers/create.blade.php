    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{ __('Add New Supplier') }}</h4>
                        <form class="form-sample" method="post" action="{{ route('suppliers.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name_lt" name="name_lt" placeholder="{{ __('Name In Latin') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="state_id" id="state_id" class="form-control" required>
                                                ...
                                                <option value="{{ $state->id }}" {{ $state->id == '1106' ? 'selected' : '' }}>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            placeholder="{{ __('Address In Arabic') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            placeholder="{{ __('Address In Latin') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
